      ...
      {!(apiKey || serverSideApiKeyIsSet) ? (
        <div className="mx-auto flex h-full w-[300px] flex-col justify-center space-y-6 sm:w-[600px]">
          <div className="text-center text-4xl font-bold text-black dark:text-white">
            Welcome to Silogen-Chat
          </div>
          <div className="text-center text-lg text-black dark:text-white">
            <div className="mb-8">{`Chatbot UI is an open source clone of OpenAI's ChatGPT UI.`}</div>
            <div className="mb-2 font-bold">
              Important: Silogen-Chat is 100% unaffiliated with OpenAI.
            </div>
          </div>
          <div className="text-center text-gray-500 dark:text-gray-400">
            <div className="mb-2">
              Silogen-Chat allows you to plug in your API key to use this UI with
              their API.
            </div>
            <div className="mb-2">
            ...
            {selectedConversation?.messages.length === 0 ? (
              <>
                <div className="mx-auto flex flex-col space-y-5 md:space-y-10 px-3 pt-5 md:pt-12 sm:max-w-[600px]">
                  ...
                  {models.length > 0 && (
                    <div
                      className="max-h-custom flex flex-col space-y-4 rounded-lg border border-neutral-200 p-4 dark:border-neutral-600 overflow-auto">
                      <ModelSelect/>
